...
namespace AbstractAir.Persistence
{
		...
		where TDriver : DriverBase
	{
		...
		public PersistenceConfigurator(ICoreConfiguration coreConfiguration)
		{
			_coreConfiguration = ArgumentValidation.IsNotNull(coreConfiguration, "coreConfiguration");
		}
		...
		public void ConfigurePersistence(IEnumerable<Assembly> assemblies)
		{
			Configuration = new Configuration()
				...
				.SetProperty(NHibernate.Cfg.Environment.ConnectionString, _coreConfiguration.ConnectionString)
